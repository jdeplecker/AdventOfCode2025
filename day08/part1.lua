...
local biggest_three = {}
table.insert(biggest_three, 0)
table.insert(biggest_three, 0)
table.insert(biggest_three, 0)
for _,c in pairs(circuits) do
    local tcount = table_count(c)
    if tcount > biggest_three[1] then
        biggest_three[3] = biggest_three[2]
        biggest_three[2] = biggest_three[1]
        biggest_three[1] = tcount
    elseif tcount > biggest_three[2] then
        biggest_three[3] = biggest_three[2]
        biggest_three[2] = tcount
    elseif tcount > biggest_three[3] then
        biggest_three[3] = tcount
    end
end

print(biggest_three[1] * biggest_three[2] * biggest_three[3])